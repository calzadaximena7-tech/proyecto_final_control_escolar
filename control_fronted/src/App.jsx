...
function App() {
  ...
  function eliminarCalificacion(id) {
    fetch(`${API}/calificaciones/${id}/`, { method: 'DELETE' })
      ...
      <section>
        ...
        <form onSubmit={agregarAlumno}>
          ...
          <input
            ...
            onChange={e => setNuevoAlumno({ ...nuevoAlumno, grupo: e.target.value })}
            required
          />
      ...
      <section>
        ...
        <form onSubmit={agregarMateria}>
          ...
          <input
            ...
            onChange={e => setNuevaMateria({ ...nuevaMateria, profesor: e.target.value })}
            required
          />
      ...
      <section>
        ...
        <form onSubmit={agregarCalificacion}>
          ...
          <input
            ...
            onChange={e => setNuevaCalificacion({ ...nuevaCalificacion, calificacion: e.target.value })}
            required
          />
